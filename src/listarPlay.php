...
// Incluir el archivo database.php que contiene la conexión con la base de datos
  include("conexion_bd.php");
    ...
    // Consulta para extraer todos las columnas de la tabla Videojuegos que contengan la palabra play en la columna plataformas
    $sql = "SELECT * FROM Videojuegos WHERE plataformas LIKE '%play%'";
...
<body>
    ...
    <h1>Lista de videojuegos de Play:</h1>
