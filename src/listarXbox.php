...
// Incluir el archivo database.php que contiene la conexión con la base de datos
  ...
  // Consulta para extraer todos las columnas de la tabla Videojuegos que contengan la palabra xbox en la columna plataformas
    $sql = "SELECT * FROM Videojuegos WHERE plataformas LIKE '%xbox%'";
...
<body>
    ...
    <h1>Lista de videojuegos de Xbox:</h1>
